...
const text = {
  en: {
    ...
    preview: 'Completed card', continueToHandwriting: 'Continue to handwriting', download: 'Download PNG', share: 'Share', openImage: 'Open image to save',
  ...
  ja: {
    ...
    preview: '完成したカード', continueToHandwriting: '手書き画面へ進む', download: 'PNGをダウンロード', share: '共有', openImage: '画像を開いて保存',
  ...
  'zh-TW': {
    ...
    preview: '完成卡片', continueToHandwriting: '前往手寫完成卡片', download: '下載 PNG', share: '分享', openImage: '開啟圖片後儲存',
